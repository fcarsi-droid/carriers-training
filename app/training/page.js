...
const faultCodes = [
  ...
  { code: 'DAT201', level: 'Late incoming transport', en: 'Carrier\'s delay in making the vehicle available for loading due to any reason, e.g. vehicle breakdown', es: 'Retraso del transportista en poner a disposición el vehículo para carga, por cualquier motivo, ej. avería del vehículo', pt: 'Atraso da transportadora em disponibilizar o veículo para carregamento, por qualquer motivo, ex. pane do veículo' },
  { code: 'DAT402', level: 'Equipment breakdown (truck, vessel, aircraft)', en: 'Delayed due to transportation vehicle breakdown', es: 'Retrasado debido a avería del vehículo de transporte', pt: 'Atrasado devido a pane do veículo de transporte' },
  ...
  { code: 'DA9992', level: 'Missing ATA Entry', en: 'Arrival dates at OTM have not yet been entered. Please enter the arrival date in OTM immediately.', es: 'Las fechas de llegada en OTM aún no han sido ingresadas. Por favor, ingrese la fecha de llegada en OTM de inmediato.', pt: 'As datas de chegada no OTM ainda não foram inseridas. Por favor, insira a data de chegada no OTM imediatamente.' },
...
const mfaSteps = {
  ...
  pt: [
    ...
    { step: 11, title: 'Trocar seu dispositivo móvel', desc: 'Se precisar trocar seu dispositivo móvil, entre em contato com seu analista de transporte focal point da SCCT para gerar um ticket com a equipe de suporte OTM.' },
  ]
}
...
const modules = {
  basic: [
    ...
    { id:4, video:"https://wnypubltm64soaxh.public.blob.vercel-storage.com/module4.mp4", en:{title:"Dock & Yard Management",tag:"Module 4",desc:"Dock booking, scheduling, capacity planning, and real-time visibility.",content:`<h3>Dock Booking and Scheduling</h3><p>Plans, coordinates, and manages the arrival and departure of trucks at a warehouse to ensure efficient loading and unloading without congestion.</p><ul><li>Appointment Management: carriers reserve time slots in advance</li><li>Dock Allocation: the system assigns the most suitable dock door based on shipment type and capacity</li><li>Capacity Planning: ensures resources such as forklifts, staff, and dock space are balanced</li><li>Real-Time Visibility: live updates on truck arrival status, delays, and dock occupancy</li><li>Exception Handling: addresses late arrivals, urgent shipments, or overbooked slots</li></ul>`,quiz:[{q:"What is the main purpose of Dock Booking and Scheduling?",options:["To track driver salaries","To ensure loading and unloading happen efficiently and without congestion","To manage carrier invoices","To store shipment documents"],correct:1},{q:"Which process assigns the most suitable dock door based on shipment type?",options:["Capacity planning","Dock allocation","Exception handling","POD upload"],correct:1}]}, es:{title:"Gestión de Muelles y Patio",tag:"Módulo 4",desc:"Reserva, programación, planificación de capacidad y visibilidad en tiempo real.",content:`<h3>Reserva y programación de muelles</h3><p>Planifica, coordina y gestiona la llegada y salida de camiones para garantizar actividades eficientes sin congestión.</p><ul><li>Gestión de citas: reserva de franjas horarias con anticipación</li><li>Asignación de muelle: el sistema asigna la puerta más adecuada según tipo y capacidad</li><li>Planificación de capacidad: recursos como montacargas, personal y espacio equilibrados</li><li>Visibilidad en tiempo real: actualizaciones en vivo sobre llegadas, retrasos y ocupación</li><li>Gestión de excepciones: llegadas tardías, envíos urgentes o sobrecontratación</li></ul>`,quiz:[{q:"¿Cuál es el propósito principal de la Reserva y Programación de Muelles?",options:["Rastrear salarios de conductores","Garantizar que las actividades de carga y descarga ocurran eficientemente sin congestión","Gestionar facturas de transportistas","Almacenar documentos de envío"],correct:1},{q:"¿Qué proceso asigna la puerta de muelle más adecuada?",options:["Planificación de capacidad","Asignación de muelle","Gestión de excepciones","Carga de POD"],correct:1}]}, pt:{title:"Gestão de Docas e Pátio",tag:"Módulo 4",desc:"Agendamento de docas, planejamento de capacidade e visibilidade em tempo real.",content:`<h3>Agendamento de docas</h3><p>Planeja, coordena e gerencia a chegada e saída de caminhões para garantir operações eficientes sem congestionamento.</p><ul><li>Gerenciamento de agendamentos: transportadoras reservam horários com antecedência</li><li>Alocação de doca: o sistema atribui a porta mais adequada com base no tipo e capacidade</li><li>Planejamento de capacidade: recursos como empilhadeiras, equipe e espaço equilibrados</li><li>Visibilidade em tempo real: atualizações ao vivo sobre chegadas, atrasos e ocupação</li><li>Gestão de exceções: chegadas atrasadas, remessas urgentes ou excesso de reservas</li></ul>`,quiz:[{q:"Qual é o principal objetivo do agendamento de docas?",options:["Rastrear salários de motoristas","Garantir que o carregamento e descarregamento ocorram eficientemente sem congestionamento","Gerenciar faturas de transportadoras","Armazenar documentos de remessa"],correct:1},{q:"Qual processo atribui a porta de doca mais adequada?",options:["Planejamento de capacidade","Alocação de doca","Gestão de exceções","Upload de POD"],correct:1}]} },
    { id:5, video:"https://wnypubltm64soaxh.public.blob.vercel-storage.com/module5.mp4", en:{title:"Dock Changes & Rescheduling",tag:"Module 5",desc:"Managing adjustments to planned dock appointments.",content:`<h3>Dock Changes and Rescheduling</h3><p>Adjustments to planned dock appointments are required when real-world events deviate from the original plan. The process ensures activities remain synchronized by:</p><ul><li>Reassigning Dock Doors: allocating a different dock to accommodate changing capacity</li><li>Modifying Appointment Times: shifting slots when carriers face delays or priority shipments must be accelerated</li><li>Balancing Workload: ensuring staff, forklifts, and space are evenly utilized</li><li>Maintaining Real-Time Coordination: keeping carriers and warehouse teams aligned with updated information</li><li>Reducing Operational Disruptions: quickly adjusting the schedule to minimize waiting times</li></ul>`,quiz:[{q:"When is Dock Rescheduling typically required?",options:["When all shipments arrive on time","When carriers share their credentials","When real-world events deviate from the original plan, such as delayed trucks","When invoices are submitted"],correct:2},{q:"What must carriers do when a dock appointment change occurs?",options:["Wait for the warehouse to notice","Notify the SCCT team promptly and update OTM in real time","Cancel the shipment","Request a new tender"],correct:1}]}, es:{title:"Cambios y Reprogramación de Muelles",tag:"Módulo 5",desc:"Gestión de ajustes a las citas de muelle planificadas.",content:`<h3>Cambios y reprogramación</h3><p>Los ajustes son necesarios cuando los eventos del mundo real se desvían del plan original. El proceso garantiza que las actividades permanezcan sincronizadas mediante:</p><ul><li>Reasignación de muelles: asignar un muelle diferente para acomodar cambios de capacidad</li><li>Modificación de horarios: cambiar franjas cuando los transportistas enfrentan retrasos</li><li>Equilibrio de carga de trabajo: garantizar que el personal y recursos estén distribuidos uniformemente</li><li>Coordinación en tiempo real: mantener a transportistas y equipos alineados con información actualizada</li><li>Reducción de interrupciones: ajustar rápidamente el horario para minimizar tiempos de espera</li></ul>`,quiz:[{q:"¿Cuándo se requiere típicamente la Reprogramación de Muelles?",options:["Cuando todos los envíos llegan a tiempo","Cuando los transportistas comparten sus credenciales","Cuando los eventos del mundo real se desvían del plan original, como camiones retrasados","Cuando se envían facturas"],correct:2},{q:"¿Qué deben hacer los transportistas cuando ocurre un cambio en la cita de muelle?",options:["Esperar a que el almacén lo note","Notificar al equipo de SCCT con prontitud y actualizar OTM en tiempo real","Cancelar el envío","Solicitar una nueva licitación"],correct:1}]}, pt:{title:"Alterações e Reagendamento de Docas",tag:"Módulo 5",desc:"Gerenciamento de ajustes nos agendamentos de docas planejados.",content:`<h3>Alterações e reagendamento</h3><p>Ajustes são necessários quando eventos reais desviam do plano original. O processo garante que as atividades permaneçam sincronizadas por meio de:</p><ul><li>Reatribuição de docas: alocar uma doca diferente para acomodar mudanças de capacidade</li><li>Modificação de horários: deslocar horários quando transportadoras enfrentam atrasos</li><li>Balanceamento da carga de trabalho: garantir que equipe e recursos estejam distribuídos uniformemente</li><li>Coordenação em tempo real: manter transportadoras e equipes alinhadas com informações atualizadas</li><li>Redução de interrupções: ajustar rapidamente o cronograma para minimizar tempos de espera</li></ul>`,quiz:[{q:"Quando o reagendamento de docas é tipicamente necessário?",options:["Quando todas as remessas chegam no prazo","Quando as transportadoras compartilham suas credenciais","Quando eventos reais desviam do plano original, como caminhões atrasados","Quando faturas são enviadas"],correct:2},{q:"O que as transportadoras devem fazer quando ocorre uma mudança no agendamento?",options:["Aguardar o armazém perceber","Notificar a equipe da SCCT prontamente e atualizar o OTM em tempo real","Cancelar a remessa","Solicitar uma nova oferta"],correct:1}]} },
