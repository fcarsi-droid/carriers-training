...
const round1 = [
  ...
  { code: 'DAT201', en: 'Carrier did not make the vehicle available on time at the origin — vehicle arrived late to start the transport', es: 'El transportista no tuvo el vehículo disponible a tiempo en el origen — el vehículo llegó tarde para iniciar el transporte', pt: 'A transportadora não disponibilizou o veículo no horário na origem — o veículo chegou atrasado para iniciar o transporte' },
  { code: 'DAT402', en: 'Delayed due to mechanical failure or breakdown of the transport vehicle during the operation (truck, vessel, aircraft)', es: 'Retrasado por falla mecánica o avería del vehículo de transporte durante la operación (camión, barco, avión)', pt: 'Atrasado devido a falha mecânica ou pane do veículo de transporte durante a operação (caminhão, navio, aeronave)' },
